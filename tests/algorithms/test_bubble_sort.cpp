...
TEST(Algorithms_Bubble_Sort, RandomNumbs) {
	...
	bubble_sort(numbs_1, NUMBS_COUNT, sizeof(*numbs_1), cmp_int);
	...
	bubble_sort(fnumbs_1, NUMBS_COUNT, sizeof(*fnumbs_1), cmp_double);
	...
	bubble_sort(numbs16_1, NUMBS_COUNT, sizeof(short), cmp_short);
